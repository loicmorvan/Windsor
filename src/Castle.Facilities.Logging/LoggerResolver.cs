...
/// <summary>Custom resolver used by Windsor. It gives us some contextual information that we use to set up a logging before satisfying the dependency</summary>
