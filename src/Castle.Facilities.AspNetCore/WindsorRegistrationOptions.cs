...
public class WindsorRegistrationOptions
{
	...
	/// <summary>
	///     Use this method to specify where controllers, tagHelpers and viewComponents are registered from. Use this method if the facility starts throwing ComponentNotFoundExceptions because of problems
	///     with <see cref = "Assembly.GetCallingAssembly" />/<see cref = "Assembly.GetEntryAssembly" />. You can optionally use <see cref = "RegisterControllers(Assembly, LifestyleType)" />/
	///     <see cref = "RegisterTagHelpers(Assembly, LifestyleType)" />/<see cref = "RegisterViewComponents(Assembly, LifestyleType)" /> if you need more fine grained control for sourcing these framework
	///     components.
	/// </summary>
