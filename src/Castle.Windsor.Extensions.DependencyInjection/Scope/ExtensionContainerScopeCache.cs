...
{
    private static readonly AsyncLocal<ExtensionContainerScopeBase> CurrentScope = new();
    ...
    {
        get => CurrentScope.Value ?? throw new InvalidOperationException("No scope available");
