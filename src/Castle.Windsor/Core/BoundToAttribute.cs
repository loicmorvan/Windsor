...
///     presenter in a two tier MVP application. The <see cref = "ScopeRootBinderType" /> attribute must point to a type having default accessible constructor and public method matching signature of
///     <code>Func&lt;IHandler[], IHandler&gt;</code> delegate.
/// </summary>
[AttributeUsage(AttributeTargets.Class)]
public sealed class BoundToAttribute : LifestyleAttribute
{
	/// <summary>Initializes a new instance of the <see cref = "BoundToAttribute" /> class.</summary>
	/// <param name = "scopeRootBinderType">
	///     type having default accessible constructor and public method matching signature of <code>Func&lt;IHandler[], IHandler&gt;</code> delegate. The method will be used to pick
	///     <see
	///         cref = "IHandler" />
