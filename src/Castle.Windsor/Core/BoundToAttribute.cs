...
///     further up the object graph. Good scenario for this would be unit of work bound to a
///     presenter in a two tier MVP application. The <see cref="ScopeRootBinderType" /> attribute must point to a type
