...
public enum LifestyleType
{
    ...
    /// <summary>
    ///     Instance lifetime and reuse scope is bound to another component further up the object graph. Good scenario for this
    ///     would be unit of work bound to a presenter in a two tier MVP application. When
    ///     specified in xml a <c>scopeRootBinderType</c> attribute must be specified pointing to a type having default
    ///     accessible constructor and public method matching signature of
