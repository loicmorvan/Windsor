...
{
    /// <param name="getMethodsResolveByName">
    ///     If set to <c>true</c>, all methods with names like 'GetSomething' will try to
    ///     resolve by name component 'something'. Defaults to <c>true</c>.
    /// </param>
    ...
    /// <summary>
    ///     Builds <see cref="TypedFactoryComponentResolver" /> for given call. By default if <paramref name="componentType" />
    ///     is a collection returns factory calling
    ...
    /// <summary>
    ///     Selects arguments to be passed to resolution pipeline. By default passes all given <paramref name="arguments" />
    ///     keyed by names of their corresponding <paramref name="method" />
    ///     parameters.
    /// </summary>
    /// <param name="method"></param>
    ...
    /// <summary>
    ///     Selects name of the component to resolve. If <paramref name="method" /> Name is GetFoo returns "Foo",
    ///     otherwise <c>null</c>.
    /// </summary>
    /// <param name="method"></param>
    /// <param name="arguments"></param>
