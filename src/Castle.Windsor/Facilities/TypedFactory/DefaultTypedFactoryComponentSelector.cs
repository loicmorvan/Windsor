...
public class DefaultTypedFactoryComponentSelector : ITypedFactoryComponentSelector
{
	...
	///     If set to <c>true</c>, will fallback to resolving by type, if can
	///     not find component with specified name. This property is here for backward compatibility. It is recommended not to
	///     use it. Defaults to <c>false</c>.
	/// </param>
