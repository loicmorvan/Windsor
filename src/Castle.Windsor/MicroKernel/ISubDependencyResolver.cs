...
{
	/// <summary>Returns true if the resolver is able to satisfy this dependency.</summary>
	...
	/// <summary>
	///     Should return an instance of a service or property values as specified by the dependency model instance. It is also the responsibility of <see cref = "IDependencyResolver" /> to throw an
	///     exception in the case a non-optional dependency could not be resolved.
	/// </summary>
	/// <param name = "context">Creation context, which is a resolver itself</param>
	/// <param name = "contextHandlerResolver">Parent resolver - normally the IHandler implementation</param>
	/// <param name = "model">Model of the component that is requesting the dependency</param>
