	...
	IKernel, IKernelEvents, IKernelInternal
{
	...
	/// <summary>Constructs a DefaultKernel with the specified implementation of <see cref = "IProxyFactory" /> and <see cref = "IDependencyResolver" /></summary>
	...
	/// <summary>
	///     Creates an implementation of <see cref = "ILifestyleManager" /> based on <see cref = "LifestyleType" /> and invokes <see cref = "ILifestyleManager.Init" /> to initialize the newly created
	///     manager.
	/// </summary>
