...
/// <remarks>
///     It allows you to register components and request them by their name or the services they expose. It also allow you
///     to register facilities and subsystem, thus augmenting the functionality exposed
...
public partial interface IKernel : IKernelEvents, IDisposable
{
	...
	/// <param name="name"></param>
	/// <returns>The <see cref="IHandler" /> for the specified component name; or <c>null</c> if none was found.</returns>
