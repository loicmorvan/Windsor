    ...
    : IComponentModelDescriptor
{
    ...
    {
        if (model.ExtendedProperties.TryGetValue(Key, out var value) &&
            value is ComponentLifecycleExtension dynamicParameters)
        {
        ...
        model.GetOrCreateResolveExtensions().Add(dynamicParameters);
