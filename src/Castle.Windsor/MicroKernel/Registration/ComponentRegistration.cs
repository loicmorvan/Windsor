...
///     <para />
///     You can create a new registration with the <see cref = "Component" /> factory.</summary>
	...
	where TService : class
{
	...
	/// <summary>The concrete type that implements the service.
	///     <para />
	///     To set the implementation, use <see cref = "ImplementedBy(System.Type)" /> .</summary>
	...
	/// <summary>Registers this component with the <see cref = "IKernel" /> .</summary>
	...
	/// <summary>Set a custom <see cref = "IComponentActivator" /> which creates and destroys the component.</summary>
	/// <returns> </returns>
	...
	/// <summary>Adds the attribute descriptor.</summary>
	...
	/// <summary>Creates an attribute descriptor.</summary>
	...
	/// <summary>
	///     Defines additional dependencies for the component. Those can be any combibation of <see cref = "ServiceOverride" />, <see cref = "Property" /> and <see cref = "Parameter" />. Use the static
	///     methods on <see cref = "Dependency" /> class to define the dependencies. See the example attached.
	/// </summary>
	...
	/// <summary>Uses an (anonymous) object as a dictionary, to specify custom dependencies.</summary>
	...
	/// <param name = "resolve"> The delegate used for providing dynamic parameters. </param>
	/// <returns> </returns>
	/// <remarks>Use <see cref = "CreationContext" /> when resolving components from <see cref = "IKernel" /> in order to detect cycles.</remarks>
	...
	/// <summary>Allows custom dependencies to by defined dynamically.</summary>
	/// <param name = "resolve"> The delegate used for providing dynamic parameters. </param>
	/// <returns> </returns>
	...
	/// <summary>Adds <typeparamref name = "TService2" /> as additional service to be exposed by this component.</summary>
	...
	/// <summary>Adds <typeparamref name = "TService2" /> and <typeparamref name = "TService3" /> as additional services to be exposed by this component.</summary>
	...
	/// <summary>Adds <typeparamref name = "TService2" /> , <typeparamref name = "TService3" /> and <typeparamref name = "TService4" /> as additional services to be exposed by this component.</summary>
	/// <typeparam name = "TService2"> The first forwarded type. </typeparam>
	/// <typeparam name = "TService3"> The second forwarded type. </typeparam>
	...
	/// <summary>
	///     Adds <typeparamref name = "TService2" /> , <typeparamref name = "TService3" /> , <typeparamref name = "TService4" /> and <typeparamref name = "TService5" /> as additional services to be exposed
	///     by this component.
	/// </summary>
	/// <typeparam name = "TService2"> The first forwarded type. </typeparam>
	/// <typeparam name = "TService3"> The second forwarded type. </typeparam>
	...
	public ComponentRegistration<TService> ImplementedBy(Type type, IGenericImplementationMatchingStrategy genericImplementationMatchingStrategy, IGenericServiceStrategy genericServiceStrategy)
	{
		...
		Implementation = type;
		if (genericImplementationMatchingStrategy != null) ExtendedProperties(Property.ForKey(Constants.GenericImplementationMatchingStrategy).Eq(genericImplementationMatchingStrategy));
		if (genericServiceStrategy != null) ExtendedProperties(Property.ForKey(Constants.GenericServiceStrategy).Eq(genericServiceStrategy));
		return this;
	}

	/// <summary>Assigns an existing instance as the component for this registration.</summary>
	...
	/// <summary>Set the interceptors for this component.</summary>
	...
	/// <summary>Sets component lifestyle to per thread.</summary>
	/// <returns> </returns>
	...
	/// <summary>
	///     Sets component lifestyle to scoped per explicit scope. If <paramref name = "scopeAccessorType" /> is provided, it will be used to access scope for the component. Otherwise the default scope
	...
	/// <summary>Sets component lifestyle to scoped per farthest component on the resolution stack where implementation type is assignable to <typeparamref name = "TBaseForRoot" /> .</summary>
	/// <returns> </returns>
	...
	/// <summary>Sets component lifestyle to scoped per nearest component on the resolution stack where implementation type is assignable to <typeparamref name = "TBaseForRoot" /> .</summary>
	/// <returns> </returns>
	...
	/// <summary>Sets component lifestyle to scoped per scope determined by <paramref name = "scopeRootBinder" /></summary>
	/// <param name = "scopeRootBinder">
	///     Custom algorithm for selection which component higher up the resolution stack should be the root of the lifetime scope for current component's instances. The delegate will be invoked when current
	///     component is about to be resolved and will be passed set of handlers to components higher up the resolution stack. It ought to return one which it designages as the root which shall scope the
	...
	/// <summary>Sets component lifestyle to pooled. If <paramref name = "initialSize" /> or <paramref name = "maxSize" /> are not set default values will be used.</summary>
	/// <returns> </returns>
	...
	/// <summary>Sets component lifestyle to singleton.</summary>
	/// <returns> </returns>
	...
	/// <summary>Sets component lifestyle to transient.</summary>
	/// <returns> </returns>
	...
	/// <summary>
	///     Set a name of this registration. This is required if you have multiple components for a given service and want to be able to resolve some specific ones. Then you'd provide the name so that
	///     Windsor knows which one of the bunch you know. Otherwise don't bother setting the name.
	///     <para />
	///     If not set, the <see cref = "Type.FullName" /> of the <see cref = "Implementation" /> will be used as the key to register the component.
	/// </summary>
	...
	/// <summary>
	///     This method as opposed to <see cref = "Named" /> should be used by tools like facilities when the name is not provided by the user, but autogenerated and user has no interest in seing this name,
	///     for example in diagnostics reports. Set a name of this registration. This is required if you have multiple components for a given service and want to be able to resolve some specific ones. Then
	///     you'd provide the name so that Windsor knows which one of the bunch you know. Otherwise don't bother setting the name.
	///     <para />
	///     If not set, the <see cref = "Type.FullName" /> of the <see cref = "Implementation" /> will be used as the key to register the component.
	/// </summary>
	/// <param name = "name"> The name of this registration. </param>
	...
	{
		if (actions != null && actions.Length != 0) return OnCreate(actions.ConvertAll(a => new LifecycleActionDelegate<TService>((_, o) => a(o))));
		return this;
	}
	...
	{
		if (actions != null && actions.Length != 0) return OnDestroy(actions.ConvertAll(a => new LifecycleActionDelegate<TService>((_, o) => a(o))));
		return this;
	}

	/// <summary>
	///     Stores a set of <see cref = "LifecycleActionDelegate{T}" /> which will be invoked when the component is destroyed which means when it's released or it's lifetime scope ends. Notice that usage of
	...
	/// <summary>Services that are already present in the container will be skipped. If no new service is left the registration will not happen at all.</summary>
	/// <returns> </returns>
	...
	/// <summary>Uses a factory to instantiate the component</summary>
	...
	/// <summary>
	///     Overrides default behavior by making the current component the default for every service it exposes. The <paramref name = "serviceFilter" /> allows user to narrow down the number of services
	///     which should be make defaults.
	/// </summary>
	...
	/// <summary>Overrides default behavior by making the current component the default for every service it exposes.</summary>
	/// <returns> </returns>
	/// <remarks>When specified for multiple components for any given service the one registered after will override the one selected before.</remarks>
	...
	/// <summary>
	///     Overrides default behavior by making the current component the fallback for every service it exposes. That is if another, non-fallback, component will be registered exposing any of the same
	///     services as this component, that other component will take precedence over this one, regardless of order in which they are registered
	/// </summary>
	/// <returns> </returns>
	...
	/// <summary>Filters (settable) properties of the component's implementation type to ignore.</summary>
	/// <param name = "propertySelector">
	///     Predicate finding properties to ignore. If it returns <c>true</c> the property will not be added to <see cref = "ComponentModel.Properties" /> collection and Windsor
	...
	/// <summary>Filters (settable) properties of the component's implementation type to expose in the container and specifies if matched properties are considered mandatory.</summary>
	/// <param name = "filter">
	///     Rules for deciding whether given properties are exposed in the container or ignored and if they are mandatory, that is Windsor will only successfully resole the component if it can provide value
