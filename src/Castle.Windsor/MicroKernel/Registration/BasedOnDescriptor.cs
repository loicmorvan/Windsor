...
public class BasedOnDescriptor : IRegistration
{
	...
	/// <summary>Adds another type to be accepted as base.</summary>
	...
	/// <summary>Allows customized configurations of each matching type.</summary>
	...
	/// <summary>Allows customized configurations of each matching component with implementation type that is assignable to <typeparamref name = "TComponentImplementationType" /> .</summary>
	...
	/// <summary>Allows customized configurations of each matching component that satisfies supplied <paramref name = "condition" />.</summary>
	...
	/// <summary>Allows customized configurations of each matching component that satisfies supplied <paramref name = "condition" /> and alternative configuration for the rest of components.</summary>
	/// <param name = "condition"> Condition to satisfy </param>
	...
	/// <summary>Assigns a conditional predication which must not be satisfied.</summary>
	...
	/// <summary>Sets component lifestyle to scoped per component <typeparamref name = "TBaseForRoot" />.</summary>
	/// <returns> </returns>
	...
	{
		if (unlessFilter == null) return false;
	...
	internal bool TryRegister(Type type, IKernel kernel)
	{
		...
		if (configuration != null) configuration(registration);
