...
/// <summary>
///     Entry point to fluent way to register, by convention, multiple concrete (non-abstract) classes (that include also
///     delegate types). Use static methods on the class to fluently build
///     registration.
/// </summary>
