...
public interface ILifestyleManager : IDisposable
{
	...
	///     Also the instance should be set to <see cref="Burden.SetRootInstance" />,
	///     <see
	///         cref="Burden.RequiresPolicyRelease" />
	///     should be also set if needed
	///     and if a new instance was created it should be passed on to <see cref="IReleasePolicy.Track" /> of
	///     <paramref
	///         name="releasePolicy" />
	///     .
	/// </summary>
