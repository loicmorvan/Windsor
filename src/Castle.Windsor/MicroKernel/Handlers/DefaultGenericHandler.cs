...
{
	private readonly IGenericImplementationMatchingStrategy implementationMatchingStrategy = implementationMatchingStrategy;
	private readonly IGenericServiceStrategy serviceStrategy = serviceStrategy;
