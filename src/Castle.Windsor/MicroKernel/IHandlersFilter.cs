...
/// <summary>
///     Implementation of this interface allows for extension of the way the container looks up multiple handlers. It
///     provides the necessary hook to allow for business logic to prioritize, filter, and
...
public interface IHandlersFilter
{
	...
	/// <summary>
	///     Select the appropriate handlers (if any) from the list of defined handlers, returning them in the order they should
	///     be executed. The returned handlers should members from the
