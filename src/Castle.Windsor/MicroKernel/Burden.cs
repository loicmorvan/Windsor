...
public class Burden
{
	...
	///     . If
	///     <c>false</c>
	///     , the object has a well defined, detectable end of life (web-request end, disposal of the container etc), and will
	...
	{
		if (_dependencies == null) _dependencies = new List<Burden>(Model.Dependents.Length);
