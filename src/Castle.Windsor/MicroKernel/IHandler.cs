...
public interface IHandler : ISubDependencyResolver
{
	...
	/// <summary>Implementors should return a valid instance for the component the handler is responsible. It should throw an exception in the case the component can't be created for some reason</summary>
	/// <returns></returns>
	...
	/// <summary>
	///     Implementors should return a valid instance for the component the handler is responsible. It should return null in the case the component can't be created for some reason. No exception should be
	///     thrown.
	/// </summary>
	/// <returns></returns>
