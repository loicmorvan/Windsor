...
public interface IKernelEvents
{
	...
	///     That is when container is about to exit<see cref="IKernel.Register" /> method. This event is raised once regardless
	///     of how many components were registered.
	///     If the <see cref="IKernel.Register" /> is called by <see cref="IWindsorContainer.Install" /> the event is raised
	///     when that method exits.
	/// </summary>
	...
	///     overload) and the collection is empty.
