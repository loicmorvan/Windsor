...
public abstract class AbstractTypeConverter : ITypeConverter
{
	...
	/// <returns></returns>
	/// <remarks>The default behavior is to just pass it to the normal CanHadnleType peeking into the configuration is used for some advanced functionality</remarks>
