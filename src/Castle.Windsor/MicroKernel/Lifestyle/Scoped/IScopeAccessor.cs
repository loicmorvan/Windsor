...
/// <remarks>
///     Implementors should also ensure proper initialization of <see cref="IScopeCache" /> when accessed for the first
///     time and ensure a thread safe implementation is used when scope or cache access
