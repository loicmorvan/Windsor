...
/// </summary>
/// <remarks>
///     Custom implementors can just override the <c>CreateInstance</c> method. Please note however that the activator is
///     responsible for the proxy creation when needed.
/// </remarks>
[Serializable]
public class DefaultComponentActivator : AbstractComponentActivator
{
 ...
 !model.Implementation.IsContextful && new SecurityPermission(SecurityPermissionFlag.SerializationFormatter).IsGranted();
#endif
	}
