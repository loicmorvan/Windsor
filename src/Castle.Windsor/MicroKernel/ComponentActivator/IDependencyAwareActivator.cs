...
public interface IDependencyAwareActivator
{
	...
	/// <summary>
	///     Should return <c>true</c> if the activated instances of the <see cref = "ComponentModel" /> are managed externally to the container. That means container will not try to track the objects in
