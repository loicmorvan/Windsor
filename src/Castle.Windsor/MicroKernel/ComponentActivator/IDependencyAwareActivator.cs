...
/// <summary>
///     Implemented by <see cref="IComponentActivator" /> which don't necessarily need dependencies from the container to
///     activate new instances of the component.
/// </summary>
public interface IDependencyAwareActivator
{
	...
	///     the container. That means container will not try to track the objects in <see cref="IReleasePolicy" />.
	/// </summary>
	/// <param name="component"></param>
	/// <returns></returns>
